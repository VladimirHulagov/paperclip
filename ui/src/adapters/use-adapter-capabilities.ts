...
const KNOWN_DEFAULTS: Record<string, AdapterCapabilities> = {
  ...
  hermes_gateway: { supportsInstructionsBundle: true, supportsSkills: true, supportsLocalAgentJwt: true, requiresMaterializedRuntimeSkills: false, supportsModelProfiles: false, supportsAcp: false },
